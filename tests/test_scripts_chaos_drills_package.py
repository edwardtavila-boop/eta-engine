"""Tests for the :mod:`apex_predator.scripts.chaos_drills` package.
...
* be registered in :data:`apex_predator.scripts.chaos_drill.DRILL_FUNCS`
...
from apex_predator.scripts.chaos_drill import ALL_DRILLS, DRILL_FUNCS
...
from apex_predator.scripts.chaos_drills._common import drill_result
