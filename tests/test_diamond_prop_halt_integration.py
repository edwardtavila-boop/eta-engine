...
def _make_receipt(signal: str, prop_ready_bots: list[str] | None = None,
                  daily_pnl: float = 0.0, total_pnl: float = 0.0,
                  consistency: float | None = None) -> object:
    ...
    return dg.GuardReceipt(
        ...
        prop_ready_bots=prop_ready_bots or [
...
def test_HALT_writes_halt_flag_file(tmp_path: Path,
...
def test_WATCH_writes_watch_flag_clears_halt(tmp_path: Path,
                                                monkeypatch: object) -> None:
...
def test_OK_clears_both_flag_files(tmp_path: Path,
                                     monkeypatch: object) -> None:
...
def test_HALT_appends_RED_alert(tmp_path: Path,
                                  monkeypatch: object) -> None:
...
def test_WATCH_appends_YELLOW_alert(tmp_path: Path,
                                      monkeypatch: object) -> None:
...
def test_OK_does_not_append_alert(tmp_path: Path,
                                    monkeypatch: object) -> None:
...
def test_get_prop_guard_signal_reads_halt_flag(tmp_path: Path,
                                                  monkeypatch: object) -> None:
...
def test_get_prop_guard_signal_reads_watch_flag(tmp_path: Path,
                                                  monkeypatch: object) -> None:
...
def test_get_prop_guard_signal_OK_when_no_flags(tmp_path: Path,
                                                  monkeypatch: object) -> None:
...
def test_halt_dominates_watch_when_both_present(tmp_path: Path,
                                                   monkeypatch: object) -> None:
