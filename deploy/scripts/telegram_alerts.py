...
=========================
Telegram alert webhook adapter for the Apex Predator stack.
...
class TelegramAdapter:
    ...
    # Send
    # ------------------------------------------------------------------
    def send(self, text: str, *, priority: str = "INFO",
        ...
        prefix = {"INFO": "\u2139\ufe0f", "WARN": "\u26a0\ufe0f",
                  "CRITICAL": "\U0001f6a8"}.get(priority, "")
    ...
    def test(self) -> dict:
        ...
        return self.send(
            f"*Apex Predator adapter online* \n"
