...
============================
One-shot deploy of the Apex Predator status page to Cloudflare Pages.
...
creates a CNAME for status.apexpredator.live.
...
def main(argv: list[str] | None = None) -> int:
    ...
    ap.add_argument("--zone", required=True, help="CF zone, e.g. apexpredator.live")
    ap.add_argument("--hostname", default="status",
                    help="hostname prefix (status -> status.apexpredator.live)")
