"""
APEX PREDATOR  //  scripts.chaos_drill
======================================
...
::
    ...
    python -m apex_predator.scripts.chaos_drill all
    python -m apex_predator.scripts.chaos_drill breaker
    python -m apex_predator.scripts.chaos_drill deadman push drift
    python -m apex_predator.scripts.chaos_drill all --json
"""
...
from apex_predator.brain.avengers.base import PersonaId, TaskResult
from apex_predator.brain.avengers.circuit_breaker import BreakerState, BreakerTripped
from apex_predator.brain.avengers.deadman import DeadmanState, DeadmanSwitch
from apex_predator.brain.avengers.drift_detector import DriftDetector, DriftVerdict
...
from apex_predator.scripts.chaos_drills import (
...
def format_report(results: list[dict[str, Any]]) -> str:
    ...
    lines: list[str] = []
    lines.append("APEX PREDATOR // CHAOS DRILL")
    lines.append("=" * 58)
    for r in results:
