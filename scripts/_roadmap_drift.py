...
* shared_artifacts.apex_predator_tests_passing  (integer)
* shared_artifacts.apex_predator_tests_failing  (integer)
* shared_artifacts.apex_predator_python_files   (integer)
...
def main(argv: list[str] | None = None) -> int:
    ...
    if not args.no_pytest:
        claimed = sa.get("apex_predator_tests_passing")
    ...
    # C2 tests_failing == 0
    failing = sa.get("apex_predator_tests_failing")
    if failing is None:
    ...
    # C3 python_files
    claimed_files = sa.get("apex_predator_python_files")
