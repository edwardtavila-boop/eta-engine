...
``var/eta_engine/state/kaizen_critique/<YYYY-MM-DD>.json`` and fires a Resend alert
...
def main(argv: list[str] | None = None) -> int:
    ...
    p.add_argument(
        ...
        help="Directory for critique outputs. Default: var/eta_engine/state/kaizen_critique",
    )
    ...
    all_records = []
    for f in audit_dir.glob("*.jsonl") if audit_dir.exists() else []:
        try:
