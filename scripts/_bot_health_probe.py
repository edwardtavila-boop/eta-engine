...
# Ensure ``apex_predator`` is importable when run from the package dir.
...
CONCRETE_BOTS: list[tuple[str, str]] = [
    ("apex_predator.bots.mnq.bot",         "MnqBot"),
    ("apex_predator.bots.eth_perp.bot",    "EthPerpBot"),
    ("apex_predator.bots.nq.bot",          "NqBot"),
    ("apex_predator.bots.sol_perp.bot",    "SolPerpBot"),
    ("apex_predator.bots.xrp_perp.bot",    "XrpPerpBot"),
    ("apex_predator.bots.crypto_seed.bot", "CryptoSeedBot"),
]
...
def _build_bot_config() -> object | None:
    ...
    try:
        cfg_mod = importlib.import_module("apex_predator.bots.base_bot")
