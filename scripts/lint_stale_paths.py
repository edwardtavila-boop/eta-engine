...
EXEMPT_PATH_FRAGMENTS = (
    ...
    "eta_full_rebrand_plan_20260427.md",  # historical rebrand plan
    # Generated historical evidence folders. Active code remains scanned;
    # these report snapshots preserve old paths by design for auditability.
    "btc_inventory",
    "btc_live",
    "broker_connections",
    "btc_paper",
