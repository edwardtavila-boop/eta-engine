...
sized cushion by watching ``run_apex_live.py`` crash on startup, and
...
----------------------
  ...
  * New key ``apex_predator_v0_1_60_preflight_hardening`` with the
    full bundle ledger.
...
def main() -> None:
    ...
    sa["apex_predator_v0_1_60_preflight_hardening"] = {
        "timestamp_utc": now,
        "version": VERSION,
        "bundle_name": (
        ...
        "theme": (
            ...
            "crashes run_apex_live at startup, read-only state volume "
        ...
        "modules_modified": [
            "apex_predator/scripts/preflight.py "
        ...
        "tests_added": [
            "apex_predator/tests/test_preflight.py "
        ...
        "closure_surface_map": {
            "R2_tick_cadence": {
                ...
                "failure_mode_without_preflight": (
                    "run_apex_live.load_runtime_config raises on "
