"""Cross-regime agreement checker: apex_predator vs mnq_bot.

The two codebases share a conceptual lineage but use different regime
taxonomies:

  apex_predator        mnq_bot
  -------------        -------
  TRENDING             RISK-ON
  RANGING              NEUTRAL
...
2. mnq_bot's ``apex_v3_framework/results/by_regime.csv`` exists and
...
Inputs
------
--apex-cross-regime PATH (default: ../apex_predator/docs/cross_regime/cross_regime_validation.json)
--mnq-by-regime PATH (default: ../mnq_bot/apex_v3_framework/results/by_regime.csv)
...
_MNQ_CANDIDATES = [
    Path("C:/Users/edwar/projects/mnq_bot/apex_v3_framework/results/by_regime.csv"),
    Path.home() / "projects" / "mnq_bot" / "apex_v3_framework" / "results" / "by_regime.csv",
    ROOT.parent / "mnq_bot" / "apex_v3_framework" / "results" / "by_regime.csv",
]
