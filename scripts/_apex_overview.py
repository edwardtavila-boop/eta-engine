...
Usage
-----
    python scripts/_apex_overview.py             # markdown
    python scripts/_apex_overview.py --compact   # one-screen terminal view
    python scripts/_apex_overview.py --json      # JSON for downstream tools
...
def _roadmap_snapshot() -> dict:
    ...
    return {
        ...
        "tests_claimed":    sa.get("apex_predator_tests_passing", "?"),
        "files_claimed":    sa.get("apex_predator_python_files", "?"),
