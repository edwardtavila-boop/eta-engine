...
_SPECS: dict[str, InstrumentSpec] = {
    ...
    "MNQ": InstrumentSpec(
        "MNQ", tick_size=0.25, point_value=2.0, commission_rt=1.40, half_spread_ticks=0.5, base_slip_ticks=2.0
    ),
    "MNQ1": InstrumentSpec(
        "MNQ1", tick_size=0.25, point_value=2.0, commission_rt=1.40, half_spread_ticks=0.5, base_slip_ticks=2.0
    ),
    "NQ": InstrumentSpec(
        "NQ", tick_size=0.25, point_value=20.0, commission_rt=4.00, half_spread_ticks=0.5, base_slip_ticks=1.5
    ),
    "NQ1": InstrumentSpec(
        "NQ1", tick_size=0.25, point_value=20.0, commission_rt=4.00, half_spread_ticks=0.5, base_slip_ticks=1.5
    ),
    "ES": InstrumentSpec(
        "ES", tick_size=0.25, point_value=50.0, commission_rt=4.00, half_spread_ticks=0.5, base_slip_ticks=1.0
    ),
    "ES1": InstrumentSpec(
        "ES1", tick_size=0.25, point_value=50.0, commission_rt=4.00, half_spread_ticks=0.5, base_slip_ticks=1.0
    ),
    "MES": InstrumentSpec(
        "MES", tick_size=0.25, point_value=5.0, commission_rt=1.40, half_spread_ticks=0.5, base_slip_ticks=1.5
    ),
    "RTY": InstrumentSpec(
        "RTY", tick_size=0.10, point_value=50.0, commission_rt=4.00, half_spread_ticks=0.5, base_slip_ticks=2.0
    ),
    "M2K": InstrumentSpec(
        "M2K", tick_size=0.10, point_value=5.0, commission_rt=1.40, half_spread_ticks=0.5, base_slip_ticks=2.0
    ),
    # CME Metals
    "GC": InstrumentSpec(
        "GC", tick_size=0.10, point_value=100.0, commission_rt=4.00, half_spread_ticks=1.0, base_slip_ticks=2.0
    ),
    "MGC": InstrumentSpec(
        "MGC", tick_size=0.10, point_value=10.0, commission_rt=1.40, half_spread_ticks=1.0, base_slip_ticks=2.0
    ),
    # NYMEX Energy
    "CL": InstrumentSpec(
        "CL", tick_size=0.01, point_value=1000.0, commission_rt=4.50, half_spread_ticks=1.0, base_slip_ticks=2.0
    ),
    "MCL": InstrumentSpec(
        "MCL", tick_size=0.01, point_value=100.0, commission_rt=1.40, half_spread_ticks=1.0, base_slip_ticks=2.0
    ),
    "NG": InstrumentSpec(
        "NG", tick_size=0.001, point_value=10000.0, commission_rt=4.50, half_spread_ticks=1.0, base_slip_ticks=3.0
    ),
    # CME FX
    "6E": InstrumentSpec(
        "6E", tick_size=0.00005, point_value=125000.0, commission_rt=4.00, half_spread_ticks=1.0, base_slip_ticks=1.5
    ),
    "M6E": InstrumentSpec(
        "M6E", tick_size=0.0001, point_value=12500.0, commission_rt=1.40, half_spread_ticks=1.0, base_slip_ticks=1.5
    ),
    # CBOT Rates
    "ZN": InstrumentSpec(
        "ZN", tick_size=0.015625, point_value=1000.0, commission_rt=4.00, half_spread_ticks=1.0, base_slip_ticks=1.0
    ),
    ...
    "GC1": InstrumentSpec(
        "GC1", tick_size=0.10, point_value=100.0, commission_rt=4.00, half_spread_ticks=1.0, base_slip_ticks=2.0
    ),
    "CL1": InstrumentSpec(
        "CL1", tick_size=0.01, point_value=1000.0, commission_rt=4.50, half_spread_ticks=1.0, base_slip_ticks=2.0
    ),
    "NG1": InstrumentSpec(
        "NG1", tick_size=0.001, point_value=10000.0, commission_rt=4.50, half_spread_ticks=1.0, base_slip_ticks=3.0
    ),
    "6E1": InstrumentSpec(
        "6E1", tick_size=0.00005, point_value=125000.0, commission_rt=4.00, half_spread_ticks=1.0, base_slip_ticks=1.5
    ),
    "ZN1": InstrumentSpec(
        "ZN1", tick_size=0.015625, point_value=1000.0, commission_rt=4.00, half_spread_ticks=1.0, base_slip_ticks=1.0
    ),
    "M2K1": InstrumentSpec(
        "M2K1", tick_size=0.10, point_value=5.0, commission_rt=1.40, half_spread_ticks=0.5, base_slip_ticks=2.0
    ),
    "YM1": InstrumentSpec(
        "YM1", tick_size=1.0, point_value=5.0, commission_rt=4.00, half_spread_ticks=0.5, base_slip_ticks=2.0
    ),
    ...
    "MYM": InstrumentSpec(
        "MYM", tick_size=1.0, point_value=0.5, commission_rt=1.40, half_spread_ticks=0.5, base_slip_ticks=2.0
    ),
    "MYM1": InstrumentSpec(
        "MYM1", tick_size=1.0, point_value=0.5, commission_rt=1.40, half_spread_ticks=0.5, base_slip_ticks=2.0
    ),
}
