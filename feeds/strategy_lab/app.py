...
st.markdown("---")
st.markdown("**Lab Report Integration:** Passed strategies generate a `lab_report.json` that attaches to `StrategyAssignment.extras` for automatic promotion to paper_soak lane.")
